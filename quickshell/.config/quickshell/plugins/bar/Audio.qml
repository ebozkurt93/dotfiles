...
Item {
    ...
    // Binds the nodes' audio properties so reading/writing volume and mute
    // actually works -- PwNode.audio is inert until the node is tracked.
    ...
    Text {
        ...
        // These Material Design speaker glyphs render visibly smaller than
        // the other bar icons' at the same font.pixelSize (Omarchy's own
        // audio panel notes the same thing about this glyph set in
        // JetBrainsMono Nerd Font), so bump the size to compensate.
        font.pixelSize: 15
