...
local _ = require("window_manager")
local _ = require("now-playing")
local _ = require("fuzzy_window_switcher")
-- local _ = require("chrome_tab_switcher")
local _ = require("firefox_tab_switcher")
